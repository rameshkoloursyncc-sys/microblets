    ...
    <div class="p-6 mt-14 min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          ...
          <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ totalMeter.toFixed(2) }}</div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <tbody>
              <tr v-for="p in visibleProducts" :key="p.id" class="border-t hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <td class="py-2 px-3">
                  ...
                  <div v-else @click="startEdit(p, 'width')" class="cursor-pointer">{{ p.width }}</div>
                </td>
                ...
                <td class="py-2 px-3 text-center">
                  ...
                  <div v-else @click="startEdit(p, 'meter')" class="cursor-pointer">
                    <span :class="getMeterClass(p)" class="font-medium">{{ Number(p.meter).toFixed(2) }}</span>
                  </div>
                </td>
